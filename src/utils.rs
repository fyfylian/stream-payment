...
//
// This file is part of fyfystream-program
//
...
/// fyfystream is the struct containing all our necessary metadata.
#[repr(C)]
pub struct fyfystream {
...
/// Deserialize instruction_data into fyfystream struct.
...
/// Deserialize account data into fyfystream struct.
/// This is used for reading the metadata from the account holding the locked funds.
pub fn unpack_account_data(ix: &[u8]) -> fyfystream {
    fyfystream {
