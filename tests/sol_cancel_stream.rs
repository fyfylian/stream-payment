...
// https://github.com/vamise/fyfy-stream-program
//
...
use fyfystream::process_instruction;
use fyfystream::utils::{any_as_u8_slice, fyfystream};
...
async fn test_cancel_stream() {
    ...
    let mut program_test =
        ProgramTest::new("fyfystream", program_id, processor!(process_instruction));
